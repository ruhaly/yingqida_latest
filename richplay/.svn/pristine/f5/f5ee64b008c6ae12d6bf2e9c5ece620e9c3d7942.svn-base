...
/**
 * @Title :MD5加密
 * @Description :MD5加密公共组件类
 * @project_name :perunsoft-util
 * @package_name :com.perunsoft.util
 * @file_name :Md5Util.java
 * @Company :杭州鹏润科技
 * @author :DingMingjin
 * @email :mingjin_ding@yahoo.cn
 * @date :2010-7-30 上午09:33:22
 */
public class Md5Util {

	public static Md5Util ins = new Md5Util();

	/**
	 * @Title :getMD5ofStr
	 * @Description :获得MD5变换后的字符串
	 * @param :@param inbuf
	 * @param :@return
	 * @author :DingMingjin
	 * @email :mingjin_ding@yahoo.cn
	 * @return :String
	 * @date :2010-7-30 上午10:36:51
	 * @throws :
	 */
	...
	public String getMD5ofStrHn(String inbuf) {
		inbuf = "BNET2TRANSFAR2006011A" + inbuf;
		md5Init();
		md5Update(inbuf.getBytes(), inbuf.length());
		md5Final();
		digestHexStr = "";
	...
	/**
	 * @Title :b2iu
	 * @Description :将byte类型的数据按照不考虑正负号的原则的＂升位＂
	 * @param :@param b
	 * @param :@return
	 * @author :DingMingjin
	 * @email :mingjin_ding@yahoo.cn
	 * @return :long
	 * @date :2010-7-30 上午10:39:02
	 * @throws :
	 */
	...
	/**
	 * @Title :byteHEX
	 * @Description :将byte类型的数转换成十六进制的ASCII表示
	 * @param :@param ib
	 * @param :@return
	 * @author :DingMingjin
	 * @email :mingjin_ding@yahoo.cn
	 * @return :String
	 * @date :2010-7-30 上午10:38:29
	 * @throws :
	 */
	...
	// {
	// Md5Util nn = new Md5Util();
	// System.out.println(nn.getMD5ofStr("123456"));
	// }
